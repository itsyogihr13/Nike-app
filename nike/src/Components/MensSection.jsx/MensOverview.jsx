    ...
    <div className="px-6">
      ...
      <div className="sticky top-[0px] w-full bg-[#fff]">
        <div className="flex w-[60%] justify-between ">
          <h1 className={`text-[20px] font-bold text-left mt-5 mb-4 `}>
            The Essentials
          </h1>
      ...
      <div className="w-full">
        ...
        <div className="text-center w-[80%]  m-auto pt-[2rem]">
          ...
          <h1 className="font-medium mt-2">
            Your build-to-last, all week wears--but with style only Jordon Brand
            can deliver
          </h1>
          <button className="primaryblk-button mt-6 rounded-[10%]">Shop</button>
        </div>
      </div>
      <h1 className="text-[30px] font-bold text-left mt-8 mb-6">
        The Essentials
